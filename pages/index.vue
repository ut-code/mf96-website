    ...
    <v-main>
      <v-container class="pa-2">
        ...
        <v-card>
          ...
          <v-card-item>
            <v-img src="first-web-game-maker.jpg" max-width="50%"> </v-img>
          </v-card-item>
        </v-card>
        <v-card>
        ...
        <v-card class="my-2">
          ...
          <v-card-text>
            ...
            <v-btn url="https://twitter.com/utokyo_code">公式Twitter</v-btn>
            <v-btn url="https://line.me/ti/p/%40nlr3843e">公式LINE</v-btn>
            <zoom />
          </v-card-text>
        </v-card>
      </v-container>
